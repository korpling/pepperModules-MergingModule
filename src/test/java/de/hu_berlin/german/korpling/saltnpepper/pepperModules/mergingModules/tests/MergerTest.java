...
public class MergerTest extends PepperManipulatorTest {
	...
	// // TODO: Why is there a Corpus named "pepperModuleTest" in here?
	// assertEquals(2,
	// getFixture().getSaltProject().getSCorpusGraphs().get(0).getSCorpora().size());
	// assertEquals(2,
	// getFixture().getSaltProject().getSCorpusGraphs().get(0).getSDocuments().size());
	//
	// assertEquals(2,
	// getFixture().getSaltProject().getSCorpusGraphs().get(0).getSDocuments().get(0).getSDocumentGraph().getSNodes().size());
	// assertEquals(2,
	// getFixture().getSaltProject().getSCorpusGraphs().get(0).getSDocuments().get(0).getSDocumentGraph().getSRelations().size());
	// }
}
